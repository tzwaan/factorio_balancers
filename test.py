...
try:
    illegal_balancer = Balancer(illegal, print2d=True, textures=TEXTURES)
...
try:
    legal_balancer = Balancer(legal, print2d=True, textures=TEXTURES)
    assert not legal_balancer.contains_sideloads
...
try:
    balancer2 = Balancer(string2, print2d=True, textures=TEXTURES)
    assert not balancer2.contains_sideloads
except (IllegalConfigurations, IllegalEntities, AssertionError) as e:
    print(repr(e))
else:
    print("No Exceptions")
...
try:
    lane_balancer = Balancer(lane, print2d=True, textures=TEXTURES)
    assert lane_balancer.contains_sideloads
except (IllegalConfigurations, IllegalEntities, AssertionError) as e:
    print(repr(e))
else:
    print("No Exceptions")
...
try:
    illegal_belt_configuration_balancer = Balancer(
        illegal_belt_configuration,
        print2d=True, textures=TEXTURES)
except (IllegalConfigurations, IllegalEntities) as e:
    print(repr(e))
else:
    print("No Exceptions")
